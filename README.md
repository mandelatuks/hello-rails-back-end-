...
## Front end repo 
[https://github.com/mandelatuks/hello-react-front-end](https://github.com/mandelatuks/hello-react-front-end/pull/1)
...
```
$ git clone github.com/mandelatuks/hello-rails-back-end-
```
```
